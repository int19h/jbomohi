...
"mi la .tailr. li re li ni'u pa tseingu" = "Tyler is my first cousin once-removed and belongs to a generation later than mine (id est, in this case: the generation immediately after mine)."

### Example 957

See "sei'au" example #1 for technically-accurate translation of English "nth cousin m-times removed".
