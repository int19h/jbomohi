## 2016-03-04T16:43:20Z — krtisfranks (comment 2845, on definition 64501)

Oops: order of differintegral

I just realized that I defined {salri} so that when its order is positive, 
then integral is meant, but this word  ({nifkemtemsalri}) so that when the 
...
argument of the order terbri for this word, as opposed to merely 1 (usually
...
not explicitly specified, especially later). But repeated usage can either 
...
quantities, frequently even while the positive quantities will almost never
be mentioned (the integral of displacement with respect to time is not very
useful). Counting down through negatives is, I think, slightly harder than 
...
'symbolic'/'pictorially intuitive' and may be fixed/righted/countered in a 
...
which is more intuitive than 'descending to'/'building down' the same. That
...
But, again, all of this is merely conventional and I might be biased by my 
culture, at the least. This stuff that makes sense to me may not at all be 
