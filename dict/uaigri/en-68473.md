...
jargon = ""
selmaho = ""
keywords = [{ word = "-apparent", sense = "", place = 0 }, { word = "eventual", sense = "future but not present/current", place = 0 }, { word = "future", sense = "but not present", place = 0 }]
+++

$x_1$ is a future but not current/eventual $x_2$ as of time $x_3$ according to standard $x_4$; $x_1$ is a soon-to-be-$x_2$; $x_1$ is an example of an $x_2$-apparent.
